...
double* matrixVectorMultiplication(double** mat, double* vec, int rows, int cols) {
...
int main(int argc, char* argv[]) {
    ...
    double* result = matrixVectorMultiplication(matrix, vector, matrix_size, vector_size);
